...
/* peg/leg obj */
struct yyContext {type_t _type; void* ptr;};
struct yyThunk {type_t _type; void* ptr; };
...
union Object {
	...
	/* LEG OBJ */
	struct yyContext yyContext; /* does not generated */
	struct yyThunk yyThunk; /* does not generated */
};
...
typedef struct _yythunk {  type_t _type; /*not original element*/ int begin, end;  yyaction  action;  struct _yythunk *next; } yythunk;

struct _yycontext {
  type_t _type; /*not original element*/
  char     *__buf;
  int       __buflen;
  int       __pos;
  int       __limit;
