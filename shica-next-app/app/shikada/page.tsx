  ...
  return (
    <div className="container">
      ...
      <DescriptionComponent title="What is Shica?">
        <p>
          Shica is a programming language that is based on the state machine model. 
          And also, it is inspired by Linden Scripting Language.
        </p>
        <p>
          Shica main purpose is integrating the state base, event driven, and distributed programming. 
        </p>
...
`}
      ...
      <DescriptionComponent title="Features">
        ...
        <p>• <strong>Intuitive state model</strong>：Using <CodeSpan>stt</CodeSpan> to define states</p>
        <p>• <strong>Concurrent processing</strong>：<CodeSpan>eventEH(arg:arg==0)</CodeSpan> allows multiple same event handlers to be defined in the same state</p> 
        <p>• <strong>Distributed processing</strong>：Using <CodeSpan>GroupListenerEH()</CodeSpan> to handle events from multiple agents</p>
      </DescriptionComponent>
