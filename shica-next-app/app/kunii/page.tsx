...
import { CodeSpan } from "@/component/page/CodeSpan"; // for code block in description
  ...
  return (
    <div className="container">
      ...
      <DescriptionComponent title="What is Sub-C?">
        <p>
          <strong>Sub-C</strong> is a subset of C programming language. It is
          designed to be a more seafty programming.
        </p>
        <p>
          Sub-C is interprited by <strong>Sub-C interpreter</strong>. It is a
          simple interpreter that is written in C and Peg/Leg.
        </p>
...
`}
      ...
      <div className="feature-grid">
        <FeatureCard title="Subset of C programming language">
          <p>You can use 'Sub-C' in unit test without any change.</p>
        </FeatureCard>

        <FeatureCard title="More seafty">
          <p>
            Sub-C is designed to be a more seafty programming. It detect many
            errors at runtime.
          </p>
        </FeatureCard>
...
`}
      ...
      <DescriptionComponent title="Features">
        ...
        <p>
          • <strong>Subset of C programming language</strong>：You can use
          'Sub-C' in unit test without any change
        </p>
        <p>
          • <strong>More seafty</strong>：It detect many errors at runtime
        </p>
        <p>
          • <strong>Interpriter written in C and Peg/Leg</strong>：It is a
          simple interpreter that is written in C and Peg/Leg
        </p>
      </DescriptionComponent>
    </div>
